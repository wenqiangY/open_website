...
The Transfer Gateway allows tokens to be transferred between OpenChat DAppChain and Ethereum networks.
...
- Gateway Go contract on the OpenChat DAppChain (DAppChain Gateway)
- Address Mapper Go contract on the OpenChat DAppChain
...
/**
 * @title Full ERC721 Token for OpenChat DAppChain
 * This implementation includes all the required and some optional functionality of the ERC721
 * standard, it also contains some required functionality for OpenChat DAppChain compatiblity.
 */
...
you may want to take a look at [openchat-truffle-doc].
...
[Transfer Gateway Example]: https://github.com/openchat/transfer-gateway-example
[openchat-js]: https://github.com/openchat/openchat-js
[openchat-truffle-doc]: web3js-openchat-provider-truffle.html
