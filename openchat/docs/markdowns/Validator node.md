## Download Stable Version of openchat

```bash
wget https://private.openchat.co/openchat/linux/build-762/openchat
chmod +x openchat
./openchat version
```
...
```json
{
  "contracts": [
    ...
    },
    {
      "vm": "plugin",
      "format": "plugin",
      "name": "openchatcoin-gateway",
      "location": "openchatcoin-gateway:0.1.0",
      "init": {
        "owner": {
          "chain_id": "extdev-plasma-us1",
...
```bash
./openchat run --persistent-peers tcp://1cba97a0a108cb0de51e5a3ff6ac15d70e0fa076@52.53.145.158:46656,tcp://367a9fa0df0afeed204c3360867e37ef03da5b97@18.144.71.222:46656,tcp://7b537b6ad25b5b13864ec20bed8803489189a274@52.53.153.109:46656,tcp://d7623e990790048db76c5d6a25e12efa818aaef1@13.57.240.102:46656
```
...
```bash
wget https://private.openchat.co/openchat/linux/build-769/openchat
chmod +x openchat
./openchat version
```
...
```bash
./openchat run --persistent-peers tcp://c50d327b10308483b8e477b8376de73b80d8b1af@3.0.41.112:46656,tcp://9bc89242b811e8616eb37e50746e25f4b1a86ec7@54.254.138.238:46656,tcp://88ba2d1759195187b47de0567a697a46099a2360@3.0.202.142:46656,tcp://6d77bd5a41289701007780311702dd6647aa39d6@13.229.250.215:46656
```
